...
const I18N_DICTIONARY = {
  th: {
    ...
    // Status Badges
    status_compliant: "ผ่านเกณฑ์ EUDR (ปลอดตัดไม้)",
    status_under_review: "โซนเฝ้าระวัง (Buffer < 500 ม.)",
    status_non_compliant: "ทับซ้อนป่าสงวน (ไม่ผ่านเกณฑ์)",
    ...
    foot_email: "<strong>อีเมล:</strong> <a href=\"mailto:6640011044@psu.ac.th\" class=\"hover:text-mezenc-mint underline\">6640011044@psu.ac.th</a>, <a href=\"mailto:6640011066@psu.ac.th\" class=\"hover:text-mezenc-mint underline\">6640011066@psu.ac.th</a>",
    foot_card_hdr: "SURAT THANI FOREST COVERAGE",
    foot_card_stat: "26 ผืนป่าสงวน (Zone C) • 3,643,595 ไร่",
    ...
    idx_sec3_stat1_val: "3,643,595 ไร่",
    ...
    idx_sec3_info_sub: "ครอบคลุมพื้นที่คุ้มครองรวมกว่า 3,643,595 ไร่",
    ...
    ov_total_area: "3,643,595.00 ไร่",
    ...
    db_hero_title: "แดชบอร์ดวิเคราะห์พื้นที่ปลูกและ<br>สถานะความสอดคล้อง",
    db_hero_title_farmer: "แดชบอร์ดสรุปข้อมูลแปลงปลูกและผลผลิตของคุณ",
    db_hero_title_factory: "แดชบอร์ดรับซื้อและวิเคราะห์ผลผลิตยางพารา",
    ...
    db_hero_sub_factory: "ติดตามสถิติการรับซื้อน้ำยางสด วิเคราะห์แนวโน้มผลผลิต มูลค่าการรับซื้อ รายแปลง/รวม และสถานะความสอดคล้องตามมาตรฐาน EUDR",
    db_factory_select_plot: "เลือกแปลงปลูกรับซื้อ:",
    db_factory_all_plots: "-- ทุกแปลงปลูกรับซื้อ (ภาพรวมผลผลิตทุกล็อต) --",
    db_factory_btn_buy: "บันทึกรับซื้อผลผลิต",
    db_factory_card_plots: "แปลงปลูกและพื้นที่รับซื้อรวม",
    db_factory_card_yield: "ผลผลิตน้ำยางสดรับซื้อรวม",
    db_factory_card_revenue: "มูลค่าการรับซื้อสะสม",
    db_factory_card_trace: "การตรวจสอบย้อนกลับ & EUDR",
    db_factory_chart_yield_title: "แนวโน้มปริมาณน้ำยางสดและ DRC %",
    db_factory_chart_yield_sub: "วิเคราะห์ปริมาณน้ำยางสดสะสม (กก.) และเปอร์เซ็นต์ DRC ตามรอบการรับซื้อ",
    db_factory_chart_rev_title: "แนวโน้มมูลค่าการรับซื้อและราคาเฉลี่ย",
    db_factory_chart_rev_sub: "วิเคราะห์ยอดการจ่ายเงินรับซื้อ (บาท) และราคารับซื้อ (บาท/กก.)",
    db_factory_chart_donut_title: "สัดส่วนภาพรวมผลผลิตและการกระจายตัว",
    db_factory_recent_title: "ประวัติการรับซื้อน้ำยางสดล่าสุด",
    ...
    map_btn_draw_new: "วาดแปลงใหม่",
    map_btn_pin_check: "ปักหมุดตรวจพิกัด",
    map_btn_cancel_draw: "ยกเลิกการวาด",
    map_btn_save_plot: "บันทึกแปลงปลูก",
    map_btn_gps_me: "GPS ของฉัน",
    map_btn_layer_toggle: "ชั้นข้อมูล",
    ...
    map_opt_satellite: "ภาพถ่ายดาวเทียม (Satellite)",
    map_opt_osm: "แผนที่ถนน (OpenStreetMap)",
    map_opt_topo: "ภูมิประเทศ (Topographic)",
    ...
    map_filter_compliant: "ผ่านเกณฑ์ EUDR (ปลอดตัดไม้)",
    map_filter_review: "โซนเฝ้าระวัง (Buffer < 500 ม.)",
    map_filter_non_compliant: "ทับซ้อนป่าสงวน (ไม่ผ่านเกณฑ์)",
    ...
    yd_th_antifraud: "การตรวจจับการสวมสิทธิ์",
    ...
    yd_btn_print_receipt: "พิมพ์ใบเสร็จ",

    // PDPA & Anti-Fraud & National ID
    lbl_id_card: "เลขประจำตัวประชาชน 13 หลัก",
    lbl_id_card_ph: "1-8499-00123-45-6",
    lbl_id_card_hint: "เชื่อมโยงเกษตรกรและบันทึกผลผลิตตามมาตรฐาน EUDR",
    lbl_pdpa_masked: "ข้อมูลคุ้มครองตาม พ.ร.บ. คุ้มครองข้อมูลส่วนบุคคล (PDPA)",
    pdpa_banner_title: "ประกาศการคุ้มครองข้อมูลส่วนบุคคล (PDPA Protection Mode)",
    pdpa_banner_desc: "ระบบซ่อนข้อมูลส่วนบุคคลและข้อมูลโฉนดที่ดินของเกษตรกรสำหรับบุคคลทั่วไป บุคลากรหรือจุดรับซื้อโปรดเข้าสู่ระบบเพื่อดูข้อมูลเต็ม",
    yd_view_mode_farmer: "มุมมองเกษตรกร (Farmer View)",
    yd_view_mode_factory: "ระบบจุดรับซื้อ & ตรวจสอบการสวมสิทธิ์ (Factory Anti-Fraud)",
    yd_quota_title: "โควตาผลผลิตชีวภาพสูงสุดรายเดือน (Biological Capacity):",
    yd_quota_normal: "ปกติ (ภายในเกณฑ์ชีวภาพ)",
    yd_quota_warning: "เฝ้าระวัง (ผลผลิตใกล้เต็มเพดาน)",
    yd_quota_danger: "ตรวจพบความผิดปกติ: ผลผลิตเกินเกณฑ์สูงสุด (> 4.5 กก./ต้น/เดือน) เฝ้าระวังการสวมสิทธิ์",
  ...
  en: {
    ...
    foot_email: "<strong>Email:</strong> <a href=\"mailto:6640011044@psu.ac.th\" class=\"hover:text-mezenc-mint underline\">6640011044@psu.ac.th</a>, <a href=\"mailto:6640011066@psu.ac.th\" class=\"hover:text-mezenc-mint underline\">6640011066@psu.ac.th</a>",
    foot_card_hdr: "SURAT THANI FOREST COVERAGE",
    foot_card_stat: "26 Forest Reserves (Zone C) • 3,643,595 Rai",
    ...
    idx_sec3_stat1_val: "3,643,595 Rai",
    ...
    idx_sec3_info_sub: "Covering over 3,643,595 Rai of protected conservation territory",
    ...
    ov_total_area: "3,643,595.00 Rai",
    ...
    // ================= DASHBOARD.PHP =================
    db_hero_tag: "DECISION SUPPORT SYSTEM (DSS) • SURAT THANI",
    db_hero_title: "Spatial Plantation Analytics &<br>EUDR Compliance Dashboard",
    db_hero_title_farmer: "My Rubber Plantation & Yield Analytics Summary",
    db_hero_title_factory: "Factory Sourcing & Rubber Production Dashboard",
    ...
    db_hero_sub_factory: "Monitor fresh latex sourcing statistics, yield & price trends, total purchasing value, and EUDR zero-deforestation compliance.",
    db_factory_select_plot: "Select Sourcing Plot:",
    db_factory_all_plots: "-- All Sourcing Plots (Aggregated Overview) --",
    db_factory_btn_buy: "Record Sourcing Yield",
    db_factory_card_plots: "Total Sourcing Plots & Area",
    db_factory_card_yield: "Total Sourced Fresh Latex",
    db_factory_card_revenue: "Total Purchasing Value",
    db_factory_card_trace: "Traceability & EUDR Status",
    db_factory_chart_yield_title: "Sourced Yield & DRC % Trend",
    db_factory_chart_yield_sub: "Fresh latex volume (kg) and Dry Rubber Content (%) per sourcing cycle",
    db_factory_chart_rev_title: "Purchasing Value & Price Trend",
    db_factory_chart_rev_sub: "Total sourcing cost (THB) and buying price per kg (THB/kg)",
    db_factory_chart_donut_title: "Sourcing Distribution & Quality Breakdown",
    db_factory_recent_title: "Recent Fresh Latex Sourcing Deliveries",
    ...
    map_opt_satellite: "Satellite Imagery",
    map_opt_osm: "OpenStreetMap Roads",
    map_opt_topo: "Topographic Map",
    ...
    yd_th_antifraud: "Anti-Fraud Status",
    yd_no_data: "No harvest yield records found in system.",
    yd_receipt_title: "Rubber Latex Purchase Receipt",
    yd_receipt_sub: "EUDR Compliant Fresh Latex Delivery Receipt",
    yd_btn_print_receipt: "Print Receipt",

    // PDPA & Anti-Fraud & National ID
    lbl_id_card: "National ID (13 Digits)",
    lbl_id_card_ph: "1-8499-00123-45-6",
    lbl_id_card_hint: "Linked with farmer identity and EUDR traceability",
    lbl_pdpa_masked: "Protected under Personal Data Protection Act (PDPA)",
    pdpa_banner_title: "Personal Data Protection Notice (PDPA Mode)",
    pdpa_banner_desc: "Personal farmer identification and deed numbers are masked for public viewers. Authorized personnel please sign in.",
    yd_view_mode_farmer: "Farmer View",
    yd_view_mode_factory: "Factory Purchasing & Anti-Fraud Hub",
    yd_quota_title: "Max Monthly Biological Capacity:",
    yd_quota_normal: "Normal (Within biological limit)",
    yd_quota_warning: "Warning (Near capacity limit)",
    yd_quota_danger: "Anomaly Detected: Cumulative yield exceeds biological maximum (> 4.5 kg/tree/month). Anti-fraud alert triggered.",
